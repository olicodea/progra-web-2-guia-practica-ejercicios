<h4>Elegir pasos del menú</h4>
<form action="resultado-ej-13.php" class="card" method="POST" enctype="application/x-www-form-urlencoded">
    ...
    <div class="form-checkbox">
        ...
        <input type="checkbox" name="postre" id="postre">
    </div>
