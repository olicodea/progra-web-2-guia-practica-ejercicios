...
function imprimirImagenes() {
    foreach (getImagenes() as $imagen) {
        echo "<a href='../../ejercicios/ejercicio 10/insta-img.php/?img=../../../imagenes/$imagen&imgNombre=$imagen'>$imagen</a>";
    }
}

function imprimirForm() {
    $form = "<form class='card' action='resultado-ej-10.php' method='POST' enctype='multipart/form-data'>";
